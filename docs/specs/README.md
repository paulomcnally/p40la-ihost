...
| SPEC-082 | Bot Telegram: un mensaje por servicio y por deuda + totales por moneda al final | draft | 2026-09-19 | paulomcnally |
...
*Última actualización de este tracker: 2026-09-19 — SPEC-082 (Bot Telegram: un mensaje por servicio y por deuda + totales por moneda al final) draft.*
