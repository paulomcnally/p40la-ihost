...
| 2026-09-02 | p40la-ihost-team | Agregado campo `active` (booleano) para habilitar/deshabilitar envío de mails |
| 2026-09-02 | p40la-ihost-team | Estado cambiado de draft a in_progress; inicio de desarrollo en worktree |
| 2026-09-02 | p40la-ihost-team | Implementación completa: migración 0018, API CRUD /api/notifications, NotificationsPage y NotificationFormPage, i18n es/en. Validada en local (puerto 8090) y por API. Estado a released. |