...
| 2026-09-11 | paulomcnally | Release: merge a `main`, issue #72 cerrado con label `spec/released`. Commit: `SPEC-069: webhooks por servicio para facturas (upsert + api_key global + base URL configurable)`. |