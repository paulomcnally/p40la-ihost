...
export const api = {
  ...
  autos: {
    ...
    updateService: (id: number, serviceId: number, body: { coverage_type: string; policy_number: string; certificate?: string; insurer_number: string }) => put(`/api/autos/${id}/services/${serviceId}`, body),
